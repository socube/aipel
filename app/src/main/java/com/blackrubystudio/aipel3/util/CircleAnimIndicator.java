...
/**
 * Created by jaewoo on 2016. 12. 28..
 */
...
public class CircleAnimIndicator extends LinearLayout {
    ...
    public void createDotPanel(int count , int defaultCircle , int selectCircle) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            imageDot[i].setScaleType(ImageView.ScaleType.FIT_CENTER);
            imageDot[i].setPadding(itemMargin,itemMargin,itemMargin,itemMargin);
